...
class Bunbun extends React.Component {
    ...
    handleScroll = (e) => {
        ...
        let element = e.target //element is the whole space below navbar
                ...
                <div className='sidebar__container'>
                    ...
                    <div id="b__main__container" className='main__container'>
                        ...
                        <div id="b__research" className='research' ref={this.research_ref}>
                            ...
                            <p><b>Competitors analyzed</b>: amazon.com, foxinthesnow.com, bunniecakes.com</p>
                            <p>Based on the competitor analysis, I compiled a list of <b>wanted features</b>:</p>
...
*Navigation is made more intuitive by following design patterns. The simplicity is emphasized through the linear workflow and the color choices. </p>
                            ...
                            <br />
                            <p><b>Color Scheme Choice</b>: I chose a yellow and brown color scheme that both matches the color of cinnamon rolls and indicates a sense of warmth and welcome. The colors are also more natural and appetite-stimulating, appealing to the users. </p>
